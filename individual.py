...
class Individual(ABC):
    def __init__(self):
        self.score = 0
        # if score == -1 then the individual is cleared
...
class RealValuedIndividual(Individual):
    ...
    def crossover(self, other: "RealValuedIndividual", offset=0.1) -> "RealValuedIndividual":
        ...
        return RealValuedIndividual(len(self.traits), self.possible_genes, traits=child_traits)
